...
import { getAutonomyConfig } from "@/lib/framework-config";
...
/**
 * Displays autonomy level with greyscale card styling.
 * Returns null if autonomy level is not set or not found in config.
 */
export function AutonomyCard({
  ...
  const config = getAutonomyConfig(autonomyLevel);
